...
public class TimeScheduleAlarmService extends Service {
    ...
    private long[] vibratorPatten=new long[]{0,2000,2000};
    @Nullable
    @Override
    ...
    private NotificationCompat.Builder CreateNoti(Context context,Intent intent){
        ...
        noti.setDeleteIntent(getServiceDownIntent(context));
        noti.setForegroundServiceBehavior(NotificationCompat.FOREGROUND_SERVICE_IMMEDIATE);
        return noti;
    }
    private PendingIntent getContentIntent(Context context, int Hour, int Minuet){
    ...
    private PendingIntent getServiceDownIntent(Context context){
